...
clean-src:
	-$(RM) ./src/cr_startup_lpc175x_6x-FreeRTOS.d ./src/cr_startup_lpc175x_6x-FreeRTOS.o ./src/crp.d ./src/crp.o ./src/espserialtest.d ./src/espserialtest.o ./src/locktest.d ./src/locktest.o ./src/main.d ./src/main.o ./src/menus.d ./src/menus.o ./src/networktest.d ./src/networktest.o ./src/printf-stdarg.d ./src/printf-stdarg.o
