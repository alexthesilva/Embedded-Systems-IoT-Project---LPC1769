...
clean-src:
	-$(RM) ./src/rtosbh1750.d ./src/rtosbh1750.o ./src/rtosencoder.d ./src/rtosencoder.o ./src/rtosespserial.d ./src/rtosespserial.o ./src/rtoslcd.d ./src/rtoslcd.o ./src/rtosled.d ./src/rtosled.o ./src/rtoslock.d ./src/rtoslock.o ./src/rtospir.d ./src/rtospir.o ./src/rtosrtc.d ./src/rtosrtc.o ./src/rtostimeout.d ./src/rtostimeout.o
